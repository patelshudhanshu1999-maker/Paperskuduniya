...
<head>
    ...
    <meta name="description" content="Computer Exams 2025 - Papers Ki Duniya">
    <meta name="author" content="">
    <title>Computer Exams | Papers Ki Duniya</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-12 position-relative">
                        <h1 class="text-white display-3 fw-bold">Computer Exams</h1>
                        <p class="text-white lead">Find previous papers and details for Computer Exams</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-padding">
            <div class="container">
                ...
                <div class="row">
                    ...
                    if (!empty($examsData['computer'])) {
                        foreach ($examsData['computer'] as $exam) {
                            ?>
                            <!-- Exam Item -->
                        ...
                        echo '<div class="col-12"><p class="text-center text-muted">No computer exams found.</p></div>';
                    }
                    ?>
                </div>
            </div>
